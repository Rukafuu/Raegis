  ...
  return (
    <div className="min-h-screen font-sans selection:bg-cyan-neon/30 bg-slate-950 overflow-x-hidden">
      ...
      <footer className="max-w-7xl mx-auto px-6 py-20 border-t border-white/5 mt-20 relative overflow-hidden">
        ...
        {/* Google Web AI Disclaimer */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-16 flex flex-col md:flex-row items-center gap-8 p-10 rounded-[2.5rem] border border-white/5 bg-white/[0.01] backdrop-blur-3xl group hover:border-cyan-neon/10 transition-all duration-700"
        >
          <div className="flex-shrink-0 w-16 h-16 bg-white/[0.03] rounded-[1.5rem] flex items-center justify-center border border-white/10 group-hover:bg-cyan-neon/5 group-hover:border-cyan-neon/20 transition-all duration-500 shadow-2xl">
             <svg viewBox="0 0 48 48" className="w-8 h-8 group-hover:scale-110 transition-transform duration-500">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              <span className="text-[10px] font-mono font-black text-cyan-neon/40 uppercase tracking-[0.4em]">Official_Lab_Test_Environment</span>
              <div className="h-px flex-1 bg-white/5" />
            </div>
            <p className="text-lg font-bold text-slate-300 leading-snug group-hover:text-white transition-colors">
              {t.footer.googleLab}
            </p>
          </div>
        </motion.div>
